        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JacketUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plateform_VideoGames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Plateform_VideoGames_Plateforms_PlateformId",
                        column: x => x.PlateformId,
                        principalTable: "Plateforms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Plateform_VideoGames_VideoGames_VideoGameId",
                        column: x => x.VideoGameId,
                        principalTable: "VideoGames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Questions_VideoGames_VideoGameId",
                        column: x => x.VideoGameId,
                        principalTable: "VideoGames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_VideoGames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_User_VideoGames_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_VideoGames_VideoGames_VideoGameId",
                        column: x => x.VideoGameId,
                        principalTable: "VideoGames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plateform_VideoGames_PlateformId",
                table: "Plateform_VideoGames",
                column: "PlateformId");

            migrationBuilder.CreateIndex(
                name: "IX_Plateform_VideoGames_VideoGameId",
                table: "Plateform_VideoGames",
                column: "VideoGameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_VideoGames_UserId",
                table: "User_VideoGames",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_User_VideoGames_VideoGameId",
                table: "User_VideoGames",
                column: "VideoGameId");
